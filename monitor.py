...
ПРАВИЛА:
- ДОБАВИТЬ материал → только если есть ссылка/URL ИЛИ явные слова "добавь", "опубликуй", "размести", "создай", "запости", "внеси новую", "новая новость", "новое мероприятие". Сформируй карточку из содержимого ссылки/текста, сам предложи раздел и дату.
- ЕСЛИ в сообщении НЕТ ссылки И НЕТ явных слов добавления → это ВСЕГДА изменение существующей записи. Найди запись по названию или смыслу в контексте сайта, верни type=edit. НИКОГДА не предлагай add_news или add_event в этом случае.
- ИЗМЕНИТЬ/ПОМЕНЯТЬ/ИСПРАВИТЬ/ОБНОВИТЬ поле существующей записи → ВСЕГДА type=edit, найди запись по названию или id в контексте сайта, покажи что изменится.
