...
- ИЗМЕНИТЬ/ПОМЕНЯТЬ/ИСПРАВИТЬ/ОБНОВИТЬ поле существующей записи → ВСЕГДА type=edit, найди запись по названию или id в контексте сайта, покажи что изменится. НИКОГДА не предлагай add_news или add_event для существующих записей.
